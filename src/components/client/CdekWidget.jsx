...
function CdekWidget() {
    const { addressPrice, setAddressPrice } = useAddressPrice();
    console.log("AddressPrice в виджете:", addressPrice);
    // 1. Создаем ref для виджета
    const widget = useRef();
    ...
    useEffect(() => {
        ...
        widget.current = new window.CDEKWidget({
            ...
            apiKey: "cbe9a9db-8b10-4bca-92b7-be8ffe359cb9",
            ...
            onChoose(delivery, rate, address) {
                setAddressPrice([delivery, rate, address]);
